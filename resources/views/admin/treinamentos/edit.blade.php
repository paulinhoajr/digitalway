...
@section('content')
    ...
    <div class="">
        ...
        <form class="repeater" action="{{ route('admin.treinamentos.update') }}" method="post">
            @csrf
            ...
            <div class="row g-3">
                ...
                @foreach($treinamento->topicos as $topico)
                    ...
                    <div class="col-sm-2">
                        <a href="{{ route('admin.treinamentos.topico_delete', ['id'=>$topico->id]) }}">Excluir</a>
                    </div>
                    <hr class="my-1">
                @endforeach
                ...
                <div class="col-sm-6">
                    ...
                    <input type="hidden" name="escola_id" id="escola_id" value="{{ $treinamento->escola_id ?? null }}">
                </div>
                <div class="col-sm-12">
